...
public class TestDataProvider
{
    ...
    public TestDataProvider(INewsService newsService,
    ...
    public Task Init()
    {
        ...
        return Task.WhenAll(new []{newsTask, categoriesTask, commentsTask, pagesTask});
    }
    ...
    private async Task<List<CreatePageRequest>> CreateStaticPage(int count)
    {
        ...
        foreach (var staticPage in createStaticPageAsync)
        {
            ...
            var staticPageDto = new CreateStaticPageDto{ Body = body };
